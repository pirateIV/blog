...
// The legacy single-draft editor on /dashboard used to share STORAGE_KEY
// with the multi-draft studio above; separate keys stop the two payload
// formats from clobbering each other's data. Old content under the shared
// key is migrated into the multi-draft studio on first load.
export const LEGACY_STORAGE_KEY = "author-studio-legacy-draft-v1";
